...
import com.minfo.carrepairseller.entity.query.PartsItem;
...
public class OEMQueryActivity extends BaseActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState, R.layout.activity_oemquery);
    }
