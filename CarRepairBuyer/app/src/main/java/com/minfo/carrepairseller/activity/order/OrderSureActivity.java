...
//    private TextView tvPayment; // 支付方式
    ...
    private String wxAppid = "wx4d9f692ef2985664";
...
//                "*" + address);
        ...
        Map<String, String> params = utils.getParams(utils.getBasePostStr() + "*" + Constant.userid + "*" +
                orderId);
        Log.e("reqAlipay", utils.getBasePostStr() + "*" + Constant.userid + "*" + orderId);
...
//    }
    ...
    private void reqWXOrderInfo() {
        ...
        Log.e("reqWXOrderInfo", utils.getBasePostStr() + "*" + Constant.userid + "*" + orderId);
        ...
        httpClient.post(url, params, new RequestListener() {
            ...
            public void onRequestNoData(BaseResponse response) {
                ...
                if (errorcode == 30) {
                    ...
                    ToastUtils.show(mActivity, "该订单为设置收货地址");
                } else if (errorcode == 71) {
                    ToastUtils.show(mActivity, "微信支付不成功");
                } else if (errorcode == 72) {
                    ToastUtils.show(mActivity, "该订单已支付");
                } else {
                    ToastUtils.show(mActivity, "服务器繁忙");
                }
            }
...
//                    ToastUtils.show(mActivity,"服务器繁忙");
    ...
    private void reqYuePay() {
        Map<String, String> params = utils.getParams(utils.getBasePostStr() + "*" + Constant.userid + "*" + orderId);
        Log.e("reqYuePay", utils.getBasePostStr() + "*" + Constant.userid + "*" + orderId);
