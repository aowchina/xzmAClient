...
import com.minfo.carrepairseller.fragment.PinPaiChoseFragment;
import com.minfo.carrepairseller.fragment.XiChoseFragment;
import com.minfo.carrepairseller.fragment.XingChoseFragment;
...
//    private LinearLayout llWaitAccess;
    ...
    protected void findViews() {
        ...
        if(intent != null) {
            isDuo = intent.getBooleanExtra("isPurchase", false);
        }
...
//        llWaitAccess.setOnClickListener(this);
        ...
        bundle.putBoolean("isPurchase", isDuo);
...
//                break;
    ...
    @Override
    public void jumpFragment(PinpaiItem pinPaiEntity) {
        choseFragment.setPinpaiItem(pinPaiEntity);
        mViewPager.setCurrentItem(1);
    }
