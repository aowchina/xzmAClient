...
import com.minfo.carrepairseller.dialog.ChoosePaymentView;
import com.minfo.carrepairseller.dialog.TipView;
import com.minfo.carrepairseller.entity.order.OrderSureEntity;
import com.minfo.carrepairseller.entity.order.OrderSureQGEntity;
...
import com.minfo.carrepairseller.utils.MD5;
import com.minfo.carrepairseller.utils.PayResult;
...
import com.minfo.carrepairseller.wxapi.WXPayEntryActivity;
...
public class OrderSureQGActivity extends BaseActivity implements View.OnClickListener {
...
//    private TextView tvPayment; // 支付方式
    ...
    private OrderSureQGEntity orderSureEntity;
    //    private OrdeList_Entity underOrdeEntity;
    private List<OrderSureQGEntity.GoodInfo> list = new ArrayList<>();
    private CommonAdapter<OrderSureQGEntity.GoodInfo> msladapter;
    //支付宝常量
...
//        setContentView(R.layout.activity_QG_ORDER_sure);
    }
...
//        tvTime.setVisibility(View.VISIBLE);
    ...
    protected void initViews() {
        ...
        msladapter = new CommonAdapter<OrderSureQGEntity.GoodInfo>(mActivity, list, R.layout.item_order_product) {
            @Override
            public void convert(BaseViewHolder helper, OrderSureQGEntity.GoodInfo item, int position) {
                ...
                helper.setText(R.id.tv_price, TypeChangeUtil.getTypeFrom(item.getType()));
                helper.setText(R.id.tv_num, "￥" + item.getTotalMoney());
...
//                    addressId = data.getStringExtra("addressId");
    ...
    private void rqdata() {
        ...
        orderSureEntity = new OrderSureQGEntity();
...
//        }
    ...
    private void reqOrderInfo() {
        ...
        final String url = getResources().getString(R.string.api_baseurl) + ConstantUrl.URL_QG_ORDER_MAKE_SURE;
        httpClient.post(url, params, new RequestListener() {
            ...
            public void onRequestSuccess(BaseResponse response) {
                ...
                orderSureEntity = response.getObj(OrderSureQGEntity.class);
                list.clear();
                //控件赋值
                companyName.setText(orderSureEntity.getName());
                companyPhone.setText(orderSureEntity.getTel());
                companyAddress.setText(orderSureEntity.getAddress());
                pay_amount.setText("￥" + orderSureEntity.getTotalMoney());
...
//                "*" + address);
        ...
        Map<String, String> params = utils.getParams(utils.getBasePostStr() + "*" + Constant.userid + "*" +
                orderId);
        final String url = getResources().getString(R.string.api_baseurl) + ConstantUrl.URL_QG_ORDER_BEFORE_ALIPAY;
//                "order/ToPay.php";
        LG.e("确认订单", "url="+url);
        httpClient.post(url, params, new RequestListener() {
            @Override
...
//                pay();
            ...
            public void onRequestNoData(BaseResponse response) {
                cleanWait();
                int errorcode = response.getErrorcode();
                // 12，13，34，35，37，41，61，70// 11，12,29，30，49
                switch (errorcode) {
                    case 11:
                    case 12:
                    ...
                    case 30: // 订单ID非法
                        ...
                        break;
                    case 49: // 已支付的订单不能取消
                        ToastUtils.show(mActivity, "该订单已发货，请于收货后再退货");
                        break;
                    default:
                        ToastUtils.show(mActivity, "服务器繁忙");
                        break;
...
//        ivWeichat.setImageResource(R.mipmap.unchose_order);
    ...
    private void reqWXOrderInfo() {
        ...
        final String url = getResources().getString(R.string.api_baseurl) + "qgorder/WxPay.php";
        httpClient.post(url, params, new RequestListener() {
            @Override
            public void onPreRequest() {
                showWait();
            ...
            public void onRequestSuccess(BaseResponse response) {
                ...
                try {
                    ...
                    WXPayEntryActivity.setmActivity(mActivity);
...
//                if(true) {
//                    ToastUtils.show(mActivity, "权限审核中");
//                    return;
//                }
                reqWXOrderInfo();
            } else if(isYue) {
    ...
    public void reqOrderCancle() {
        String url = getResources().getString(R.string.api_baseurl) + ConstantUrl.URL_QG_ORDER_CANCLE;
        Map<String, String> params = utils.getParams(utils.getBasePostStr() + "*" + Constant.userid + "*" + orderId);
        httpClient.post(url, params, new RequestListener() {
            @Override
            public void onPreRequest() {
...
//                binData(Data);
            ...
            public void onRequestError(int code, String msg) {
                cleanWait();
                ToastUtils.show(mActivity, "请求服务器失败，请检查您的网络！");
            }
        });
    }
...
//                    ToastUtils.show(mActivity,"服务器繁忙");
    ...
    private void reqYuePay() {
        ...
        final String url = getResources().getString(R.string.api_baseurl) + ConstantUrl.URL_QG_ORDER_YUE_PAY;
        httpClient.post(url, params, new RequestListener() {
            @Override
            public void onPreRequest() {
                showWait();
