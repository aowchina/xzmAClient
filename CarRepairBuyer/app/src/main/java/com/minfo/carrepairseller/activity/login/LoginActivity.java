...
import com.minfo.carrepairseller.dialog.login.DsfLogin;
import com.minfo.carrepairseller.entity.ChatConstant;
...
import com.minfo.carrepairseller.utils.Emoji;
...
public class LoginActivity extends BaseActivity implements View.OnClickListener, PlatformActionListener {
    ...
    private boolean isLogHuanxin = false;
...
//            finish();
    ...
    public void loginSuccess(BaseResponse response) {
        cleanWait();
        LG.e("登录", "response=" + response.getData());
        if (response.getData() != null && !response.getData().equals("")) {
            ...
            if (loginEntity != null) {
                if(LoginFlag != 3) {
                    utils.setUserid(this, Integer.parseInt(loginEntity.getUserid()));
        ...
        switch (v.getId()) {
            ...
            case R.id.login_button:
                if (isOnline()) {
                    ...
                    ToastUtils.show(mActivity, "请检查您的网路");
                }
...
//                Log.e("login: onSuccess", "login: onSuccess");
//
