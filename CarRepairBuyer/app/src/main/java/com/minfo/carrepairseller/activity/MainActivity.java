...
import com.minfo.carrepairseller.activity.publish.AskToBuyActivity;
import com.minfo.carrepairseller.activity.publish.PartsPublishActivity;
import com.minfo.carrepairseller.fragment.PersonlFragment;
import com.minfo.carrepairseller.fragment.PublishFragment;
import com.minfo.carrepairseller.fragment.PurchaseFragment;
import com.minfo.carrepairseller.fragment.QueryFragment;
import com.minfo.carrepairseller.fragment.ShopFragment;
import com.minfo.carrepairseller.utils.Constant;
import com.minfo.carrepairseller.utils.LG;
import com.minfo.carrepairseller.widget.CircleViewRed;
import com.minfo.carrepairseller.widget.GradientTextView;
...
public class MainActivity extends BaseActivity implements View.OnClickListener{
    ...
    private final String TAG_FRAGMENT_QUERY = "query";
    private final String TAG_FRAGMENT_SHOP = "shop";
    private final String TAG_FRAGMENT_PURCHASE = "purchase";
    private final String TAG_FRAGMENT_PERSONAL = "person";
...
//            queryFragment = (QueryFragment) fragmentManager.findFragmentByTag(TAG_FRAGMENT_QUERY);
//            shopFragment = (ShopFragment) fragmentManager.findFragmentByTag(TAG_FRAGMENT_SHOP);
//            purchaseFragment = (PurchaseFragment) fragmentManager.findFragmentByTag(TAG_FRAGMENT_PURCHASE);
//            personFragment = (PersonlFragment) fragmentManager.findFragmentByTag(TAG_FRAGMENT_PERSONAL);
//            if(queryFragment == null) {
//                LG.e("queryFragment", "queryFragment==null");
//            }
        }
        ...
        switch (i) {
            ...
            case 1:
                ...
                if (queryFragment == null) {
                    ...
                    transaction.add(R.id.ll_continer, queryFragment, TAG_FRAGMENT_QUERY);
                } else {
            ...
            case 2:
                ...
                if (shopFragment == null) {
                    ...
                    transaction.add(R.id.ll_continer, shopFragment, TAG_FRAGMENT_SHOP);
                } else {
...
//                tvPublish.setmEndColor(getResources().getColor(R.color.skin_menu_text_end));
            ...
            case 3:
                ...
                if (purchaseFragment == null) {
                    ...
                    transaction.add(R.id.ll_continer, purchaseFragment, TAG_FRAGMENT_PURCHASE);
                } else {
            ...
            case 4:
                ...
                if (personFragment == null) {
                    ...
                    transaction.add(R.id.ll_continer, personFragment, TAG_FRAGMENT_PERSONAL);
                } else {
