...
import com.minfo.carrepairseller.dialog.EditMoneyView;
import com.minfo.carrepairseller.entity.wallet.WalletModel;
...
//                        radioGroup.setVisibility(View.VISIBLE);
            ...
            public void onRequestNoData(BaseResponse response) {
                ...
                switch (errorcode) {
                    ...
                    case 11:
                    case 12:
                        ToastUtils.show(mActivity, "您的登录状态异常，请重新登录！");
...
//            params = utils.getParams(utils.getBasePostStr() + "*" + Constant.userid + "*" + outMoney + "*" + "oTelMwHoQ29EpxFd-k58oAGhtZSE");
        ...
        httpClient.post(postUrl, params, new RequestListener() {
            ...
            public void onRequestNoData(BaseResponse response) {
                ...
                switch (errorcode) {
                    ...
                    case 38:
                    case 40:
                        ToastUtils.show(mActivity, "您的余额不足无法提现！");
                        break;
                    case 39:
                    ...
                    case 55:
                        ...
                        break;
                    case 58:
                        ToastUtils.show(mActivity, "暂时无法提现");
                    case 57:
            ...
            public void onRequestSuccess(BaseResponse response) {
                ...
                if (response != null) {
                    ...
                    if (walletRecordEntiry != null) {
                        ...
                        if(walletRecordEntiry.getList() != null && !walletRecordEntiry.getList().isEmpty()) {
