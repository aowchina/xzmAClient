...
public class OrderDetailQGActivity extends BaseActivity implements View.OnClickListener{
...
//                tv_sure.setVisibility(View.GONE);
        ...
        commonAdapter = new CommonAdapter<OrderDetailEntity.GoodInfo>(mActivity, productItems, R.layout.item_order_product) {
            ...
            public void convert(BaseViewHolder helper, OrderDetailEntity.GoodInfo item, int position) {
                ...
                helper.setText(R.id.tv_num, "￥"+ MyCheck.priceFormatChange(item.getTotalMoney()));
...
//                tv_sure.setVisibility(View.VISIBLE);
//                        showEnsureGone();
                        Intent intent = new Intent(mActivity, WLInfoActivity.class);
...
//                tv_sure.setVisibility(View.VISIBLE);
                    ...
                    case 1: // 待发货
                        ...
                        break;
                    case 3: // 待评价
                        Intent intent = new Intent(mActivity, AssessActivity.class);
                        Bundle bundle = new Bundle();
                        bundle.putSerializable("wlinfo", ordeDetails);
                        intent.putExtra("info", bundle);
                        startActivity(intent);
                        break;
                    case 4: // 已完成
                        Intent intentTo = new Intent(mActivity, EvaluateActivity.class);
    ...
    public void reqOrderSure() {
        String url = getResources().getString(R.string.api_baseurl) + ConstantUrl.URL_QG_ORDER_SHOUHUO;
        ...
        httpClient.post(url, params, new RequestListener() {
            ...
            public void onRequestNoData(BaseResponse response) {
                ...
                } else if (errorcode == 30 || errorcode == 35) {
...
//    String url = "http://www.kuaidiapi.cn/rest/?uid=53630&key=9a905eedbdb348d5966c9c4eac7cdea9&order=530433075434&id=zhongtong"; 网站-爱快递(http://www.kuaidiapi.cn/)
    ...
    public void reqOrdeDetails() {
        String url = getResources().getString(R.string.api_baseurl) + ConstantUrl.URL_QG_ORDER_DATIAL;
        Map<String, String> params = utils.getParams(utils.getBasePostStr() + "*" + Constant.userid + "*" + orderId);
