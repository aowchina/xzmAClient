...
//        ivAdd.setOnClickListener(this);
        ...
        province.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                LG.e("地址省onItemSelected", ""+System.currentTimeMillis());
                initCity(position);
        ...
        city.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                LG.e("地址市onItemSelected", ""+System.currentTimeMillis());
        ...
        district.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                LG.e("地址区onItemSelected", ""+System.currentTimeMillis());
...
//            tvLocal.setText("编辑收货地址");
            ...
            if (firstProvince) {
                ...
                LG.e("地址setSelection", ""+System.currentTimeMillis());
            }
            cityPos = 0;
            //匹配市id
...
//
            ...
            LG.e("地址位置赋值", ""+System.currentTimeMillis());
//
        } else {
...
//                break;
    ...
    private void reqChangeAddress() {
        ...
        httpClient.post(url, params, new RequestListener() {
            ...
            public void onRequestError(int code, String msg) {
                cleanWait();
                ToastUtils.show(EditAddressActivity.this, "请求数据失败");
            }
