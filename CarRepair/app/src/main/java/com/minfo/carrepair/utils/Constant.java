...
public class Constant {
    ...
    public final static String NOTIFY_NAME = "order_list_refresh";
    public final static String NOTIFY_STATE = "notify_state";
    public final static int NOTIFY_TYPE0 = 0; // 支付成功
    public final static int NOTIFY_TYPE1 = 1; // 取消成功
    public final static int NOTIFY_TYPE2 = 2; // 发货成功
    public final static int NOTIFY_TYPE3 = 3; // 确认收货成功
    public final static int NOTIFY_TYPE4 = 4; // 评价成功
