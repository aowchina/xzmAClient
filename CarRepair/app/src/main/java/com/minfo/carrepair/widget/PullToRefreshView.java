...
//	private String mLastUpdateTime;
	...
	private void addHeaderView() {
		// header view
		mHeaderView = mInflater.inflate(R.layout.pull_header, this, false);
...
//		}
	...
	private void footerPrepareToRefresh(int deltaY) {
		...
		if (Math.abs(newTopMargin) >= (mHeaderViewHeight + mFooterViewHeight)
			...
			mFooterTextView
					.setText(R.string.xlistview_footer_hint_ready);
...
//			mFooterTextView.setText(R.string.xlistview_footer_hint_normal);
	...
	private void footerRefreshing() {
		...
		mFooterTextView.setVisibility(GONE);
//				.setText(R.string.xlistview_header_hint_loading);
	...
	public void onHeaderRefreshComplete() {
		...
		mHeaderTextView.setText(R.string.xlistview_header_last_time);
...
//		mFooterImageView.setImageResource(R.mipmap.m_login_logo_img);
		mFooterTextView.setText("");
//		mFooterTextView.setText(R.string.xlistview_footer_hint_normal);
