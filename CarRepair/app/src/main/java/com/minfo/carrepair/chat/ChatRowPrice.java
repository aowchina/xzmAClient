 ...
 */
public class ChatRowPrice extends EaseChatRow {
    ...
    public ChatRowPrice(Context context, EMMessage message, int position, BaseAdapter adapter) {
    ...
    protected void onInflateView() {
        if (Purchase.isPriceMessage(message)) {
