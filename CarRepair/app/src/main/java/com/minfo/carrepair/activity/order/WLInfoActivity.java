...
import com.minfo.carrepair.entity.WLInfoEntity;
import com.minfo.carrepair.entity.WLInfoList;
import com.minfo.carrepair.entity.order.OrderDetailEntity;
import com.minfo.carrepair.entity.order.WLInfo;
...
public class WLInfoActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void reqWLInfo() {
        ...
        if(isQiugou) {
            ...
            Log.e("查看物流接口", utils.getBasePostStr() + "*" + Constant.userid + "*" + orderDetailEntity.getQgorderid());
