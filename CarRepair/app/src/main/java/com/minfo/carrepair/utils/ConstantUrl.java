...
public class ConstantUrl {
    ...
    public static String URL_ORDER_MAKE_SURE = "order/Detail.php"; // 确认订单接口
    public static String URL_ORDER_WL = "order/ChoiceWl.php"; // 物流名称接口
    public static String URL_ORDER_SEND = "order/GoGoods.php"; // 发货接口
    ...
    public static String URL_QG_ORDER_BEFORE_ALIPAY = "order/ZfbPay.php"; // 支付宝支付
    ...
    public static String URL_QG_ORDER_SEND = "qgorder/GoGoods.php"; // 发货

    public static String URL_ORDER_BEFORE_ALIPAY = "order/BeforePay.php"; // 支付宝支付
...
//    public static String URL_ORDER_LIST = "order/List.php"; // 订单列表
//    public static String URL_ORDER_LIST = "order/List.php"; // 订单列表
    public static String URL_GOOD_MANAGER = "goods/List.php"; // 商品管理
    public static String URL_GOOD_MANAGER_DEL_GOOD = "goods/Delete.php"; // 删除商品
    public static String URL_GOOD_MANAGER_UP_DOWN= "goods/Sj.php"; // 上下架商品
    public static String URL_GOOD_MANAGER_LAID = "goods/Update.php"; // 下架商品
