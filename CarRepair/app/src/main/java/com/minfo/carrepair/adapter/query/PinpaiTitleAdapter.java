package com.minfo.carrepair.adapter.query;
...
public class PinpaiTitleAdapter extends BaseAdapter {
    private LayoutInflater mInflater;
    private Context mCtx;
    private List<PinpaiEntity> mList;
    private int selectedPosition = -1;

    public PinpaiTitleAdapter(Context ctx, List<PinpaiEntity> list) {
        mCtx = ctx;
        mList = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        PinpaiEntity entity = mList.get(position);
...
//		title.setText(mList.get(position).getName());
        ...
        gradientTextView.setText(entity.getName());
