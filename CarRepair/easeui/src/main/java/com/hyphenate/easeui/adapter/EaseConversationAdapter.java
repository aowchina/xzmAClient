    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (conversation!=null){
            ...
            try {
                ...
                username = conversation.getLatestMessageFromOthers().getStringAttribute("userNickName");
                img = conversation.getLatestMessageFromOthers().getStringAttribute("userHeadImage");

            } catch (HyphenateException e) {
                e.printStackTrace();
                Log.e("conversation ", "e.printStackTrace()");
...
//            EaseUserUtils.setUserAvatar(getContext(), img, holder.avatar);
            EaseUserUtils.setUserNick(username, holder.name);
            holder.motioned.setVisibility(View.GONE);
            mImageLoader.displayImage(img, holder.avatar, ImageOptions.getAlbumPictureOptions());
