                        ...
                        requestRunTimePermission(new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE,Manifest.permission.READ_EXTERNAL_STORAGE,
                                ...
                                , new PermissionListener1() {
                                    ...
                                    public void onDenied(List<String> deniedPermission) {
                                        ...
                                        //权限被拒绝
                                        EaseDialogUtil.showMsgDialog(getActivity(), "提示", strToast+"才能使用此功能", "去设置", "取消", new EnsureCancleInterface() {
                                            @Override
                                            public void ensure() {
...
//                                        }
//                                        str += "权限";
//                                        Toast.makeText(getActivity(), str,Toast.LENGTH_SHORT).show();//权限被拒绝
